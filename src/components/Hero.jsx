    ...
    return (
        <section className="bg-primary w-full flex-1" id='hero' >
            <div className="flex md:flex-row item-start justify-between flex-col py-6 sm:py-20">
                ...
                <a href="#id" className="border border-white border-2xl p-1 px-4 rounded-2xl text-gradient flex justify-center items-center space-x-3">Learn Whats New <Icon.ChevronRight color="white" size={20}/> </a>
                </div>    
                ...
                <LazyMotion features={domAnimation}>
                    ...
                    >
                        <img alt="hero" src="../images/robo3.png" className="animate__flash w-[50%] h-[50%] relative z-[5]" />
